...
def predict_winners(models):
    for t in models.keys():
        ...
        for season in seasons:
            ...
            # solve ties alphabetically (for consistency)
...
def get_predicted_winner(models, season_name):
    for t in models.keys():
        print("{0}: {1}".format(t, models[t]['accuracy'][season_name]['predicted_winner']))
